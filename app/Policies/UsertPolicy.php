...
class UsertPolicy
{
    ...
    public function index(User $userAuth) {
        ...
        return in_array($userAuth->role, [$userAuth->role == "SUPERADMIN", "ADMIN", "GUEST", "EDITOR", "MEMBER"]);
    ...
    public function userShow(User $userAuth, User $user) {
        ...
        return in_array($user->role, [$user->role == "SUPERADMIN", "ADMIN", "GUEST", "EDITOR", "MEMBER"]);
